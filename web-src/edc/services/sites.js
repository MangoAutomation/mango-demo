 ...
 * @author Jose Puccini
 */
sitesFactory.$inject = ['maRestResource'];
function sitesFactory(RestResource) {
    'use strict';

    const JSON_STORE_XID = 'edc-sites';

    class Sites extends RestResource {
